...
public class CustomMethodExample {
    ...
    static class SubscribeRequest extends MailchimpMethod<SubscribeResponse> {
        /**
...
//        public MergeFields merge_fields;
    ...
    public static class SubscribeResponse extends MailchimpObject {
        @Field
        public String id;
    ...
    public static class MergeFields extends MailchimpObject {
        @Field
